...
- Nothing writes to the source. Recovered files go under the destination, via the
  `RecoverySink`; session state goes to the session directory
  ([ADR-0008](adr-0008-resumability-checkpointing.md)).
