...
| [story-0008](stories/story-0008-ci-supply-chain-hardening.md) | CI supply-chain hardening: SHA-pin all actions, lock npm tools, add SECURITY.md, least-privilege tokens | S |
