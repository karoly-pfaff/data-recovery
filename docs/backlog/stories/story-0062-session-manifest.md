...
# STORY-0062: Session manifest — provenance, SHA-256, bad sectors
...
[story-0016](story-0016-recovery-sink.md) lands, because it needs the same
...
`RetryingDevice` and imaging mode (story-0042, story-0048, M4). What this build
...
story-0019 decision, since holding every loser is the unbounded allocation
...
review (story-0057) to emit it would cost more than the forty lines of escaping
it replaces.
