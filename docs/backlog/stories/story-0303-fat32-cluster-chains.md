...
# STORY-0303: FAT32 cluster chains, the directory walk, and mounting
...
Turn the parsers [story-0302](story-0302-fat32-directory-entries.md) built into a
...
- [story-0301](story-0301-filesystem-seam.md) — the seam this arrives behind, and
...
6. **The non-conforming warning reaches the operator** — the fact story-0302's
