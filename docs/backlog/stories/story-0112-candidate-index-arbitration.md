...
# STORY-0112: File-backed candidate index + confidence arbitration
...
findings ([story-0108](story-0108-hybrid-orchestrator.md)), but nothing decides
...
- [ADR-0008](../../architecture/adr/adr-0008-resumability-checkpointing.md) —
  ...
  [story-0117](../epic-m1-vertical-slice.md).
...
4. **The interval set** — `RegionSet`, the "which bytes are spoken for"
   primitive underneath both arbitration and story-0108's `ByteAccounting`,
...
over the story-0118 fixture image, indexed through the adapters and arbitrated.
