...
# STORY-0305: exFAT entry sets, the walk, and mounting
...
Turn the parsers [story-0304](story-0304-exfat-boot-and-entry-sets.md) built into
...
sector; the mount table's order comment promised this from story-0301 and now
has to hold.
