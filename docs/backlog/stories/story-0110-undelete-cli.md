...
# STORY-0110: `revenant-undelete` CLI — modes, source, destination
...
- [Recovery output](../../architecture/recovery-output.md) — the session directory
  ...
  [story-0115](../epic-m1-vertical-slice.md).
...
and story-0117, which turns that state into something a second run resumes from,
...
recovery fact, and the full per-run record is story-0115's manifest.
...
story-0118 fixture image, once per mode. Hybrid brings back `photos/deleted.jpg`
