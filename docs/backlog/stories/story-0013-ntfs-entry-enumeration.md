...
# STORY-0013: NTFS deleted-entry enumeration + path reconstruction
...
Turn the per-record parsers of [story-0011](story-0011-ntfs-mft-record.md) and
[story-0012](story-0012-ntfs-runlist-decoder.md) into a **volume-level pass**:
...
- [Hybrid orchestration](../../architecture/hybrid-orchestration.md) — step 2b/2c:
  ...
  and its extents are what byte accounting (story-0015) consumes.
...
- [x] The MFT's own runlist is decoded and mapped with the story-0012 units;
...
Unit (`tests/unit/fs/ntfs/MftTableTest.cpp`), over the story-0065 fixture image
