...
# STORY-0064: Resumable scan — checkpoint, resume, clean cancellation
...
[story-0019](story-0019-candidate-index-arbitration.md) built the index for this
...
format allowlist are hashed into one SHA-256 (story-0062's, already in core), and
...
story-0065 fixture stopped after its first chunk leaves a checkpoint and no
