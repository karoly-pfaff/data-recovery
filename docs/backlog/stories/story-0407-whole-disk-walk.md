...
# STORY-0407: A whole disk walked as all of its partitions
...
without being told which. [story-0405](story-0405-partition-selection.md) let an
...
- [story-0405](story-0405-partition-selection.md) — `volume::readPartitionTable`
