...
# STORY-0405: Partition enumeration and selection
...
- [story-0403](story-0403-mbr-partition-table.md) and
  [story-0404](story-0404-gpt-partition-table.md) — the two schemes, and
