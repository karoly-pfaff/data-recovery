...
# STORY-0016: `RecoverySink` — naming, destination validation, extraction
...
discovery: [story-0019](story-0019-candidate-index-arbitration.md) decided *what*
...
3. **Collision handling** — two winners wanting one path is resolved by
   `disambiguate` (story-0061), against the names this run has already used.

## Design decisions

**Content-hash de-duplication moves to [story-0062](../epic-m1-vertical-slice.md).**
...
over the story-0065 fixture image — hybrid run, index, arbitrate, extract — and
