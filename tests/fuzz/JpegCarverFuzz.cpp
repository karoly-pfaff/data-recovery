...
// Invariant: arbitrary bytes into JpegCarver::carve yield a verdict or a
// typed error — never a crash, hang, or OOB read (ASan-checked in CI).
#include <algorithm>
#include <cstddef>
#include <cstdint>
#include <span>
...
extern "C" int LLVMFuzzerTestOneInput(const std::uint8_t* data, std::size_t size) {
	...
	static_cast<void>(revenant::carve::JpegCarver{}.carve(reader));
	return 0;
}
