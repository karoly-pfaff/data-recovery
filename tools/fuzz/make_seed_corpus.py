...
# --- carve formats and shared machinery (story-0606) -------------------------
#
# Eleven corpora held nothing but a `.gitkeep` until this story: all six format
# carvers and five pieces of shared machinery. Their layouts mirror the unit
# tests that build the same shapes in C++ — PngCarverTest's `minimalPng`,
# FixtureJpeg.cpp's frame — the same way the NTFS seeds above mirror
