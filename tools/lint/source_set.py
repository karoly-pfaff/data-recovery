...
the duplication detector — imports this instead of keeping its own copy, so
the covered set can only change in one place. The suffixes are the naming contract (AGENTS.md §1):
